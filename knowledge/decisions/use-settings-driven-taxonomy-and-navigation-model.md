...
- The target configuration entry is `.forma.yml`.
- `.forma/` can still be used in examples and docs as a conventional support directory.
- Space and taxonomy definitions are loaded through explicit `.forma.yml` include patterns rather than a dedicated registry file.
