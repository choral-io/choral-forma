...
Use `[[groups/default-team]]` for tool-written shared ownership that belongs to the default group. Manual `[[default-team]]` references are acceptable when they resolve unambiguously to this group.
