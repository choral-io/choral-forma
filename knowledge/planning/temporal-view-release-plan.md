...
Current authority update: after accepting all four temporal Tasks, the maintainer authorized pushing the finalized candidate to main for exact-source CI. Release workflow dispatch and Marketplace publication still require separate approval. The subsequent uncommitted dependency updates and unrelated Task governance edits are not included in the temporal closeout candidate. Earlier no-push statements below describe their original stage.
