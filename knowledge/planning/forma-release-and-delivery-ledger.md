...
- **Planned release candidate:** [[releases/forma-v0.1.26]] collects the static publishing, resolved workspace operation, runtime performance, and Agent Skill cutline. It remains planned until the exact candidate passes local and main CI gates and the maintainer approves tag publication.
