...
- The aligned 2026-07-19 quick performance gate reports a 1,000-entry `view.render` median of 68.2 ms and p95 of 74.0 ms after the complete Alpha 20 implementation. The WebApp Graph chunk is 203.41 kB / 51.15 kB gzip, and the packaged Alpha 20 VSIX is 199.68 kB.
