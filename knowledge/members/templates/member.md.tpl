...
<!--
Create this file as knowledge/members/<member-id>.md.
...
- Record confirmed membership by updating `knowledge/groups/<group-id>.md` frontmatter `members`, not by writing a `groups` field here.
