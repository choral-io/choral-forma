...
8. Keep source highlighting entirely host-owned. Forma navigation adapters must not advertise semantic-token capabilities or emit styling tokens for Markdown links, wikilinks, embeds, or schema-declared references. Pursue syntax-style improvements in the host editor or its Markdown grammar instead.
