...
- Verified the shared Graph runtime (33 focused tests), the complete 200-test workspace Vitest suite and 23 Node tooling tests, production browser bundle, packaged VSIX installation, native Preview reload, light/dark theme switching with an active selection, persistent static focus edges, and native source navigation. The packaged Alpha 20 VSIX is 199.68 KB; `markdown-preview.js` is 203.27 KB.
