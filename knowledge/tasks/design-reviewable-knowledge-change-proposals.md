...
Design how Forma should represent reviewable knowledge changes before they are
...
Product research and direction identify reviewable change proposals as a core
differentiator for human and Agent collaboration. The product should help users
and Agents maintain structured knowledge without hiding the repository as the
source of truth. The design needs to clarify whether reviewable changes map
directly to Git branches and commits, or whether Forma introduces an
intermediate proposal layer.
...
- Define how proposals relate to files, diagnostics, checks, and future write
  operations.
...
- The design states whether Forma should use direct Git diffs, an intermediate
  proposal model, or both.
...
This task should be handled before building broader write or Agent-assisted
maintenance surfaces.

## Open Questions

- Should Forma proposals be files in the workspace, local-only runtime state,
  or Git branches/commits?
- How much of this should be handled by Agent Skills instead of core Forma
  product behavior?
