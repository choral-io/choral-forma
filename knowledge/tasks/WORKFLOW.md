...
Use `readiness: ready` only when the task satisfies the Ready Checklist in `knowledge/schemas/tasks.md`. In summary, all of these must be true:
...
- issue, bug, or defect tasks include the required sections defined in `knowledge/schemas/tasks.md`;
