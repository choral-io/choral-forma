...
- The starter includes notes, tasks, members, decisions, proposals, and guidelines spaces.
...
5. Confirm proposal, decision, and guideline spaces can express ownership, review, and related-page links.
...
- Should task `status`, `readiness`, and proposal `status` be machine-validated as enum values during `check`, or remain soft guidance until schema validation is expanded?
