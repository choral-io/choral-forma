...
- Do not store group membership in member frontmatter. `knowledge/groups/*.md` frontmatter `members` is the structured membership source.
...
- Use `knowledge/.workflow/templates/member.md` as the reference template for new member profiles.
