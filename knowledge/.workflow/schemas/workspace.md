...
- `handoffs/`: handoff notes that help another member continue work with clear context. Use `knowledge/.workflow/templates/handoff.md` as a reference template when a handoff needs a durable shared file.
...
Stable member identity, responsibilities, focus areas, and public collaboration context belong in `knowledge/members/<member-id>.md`. Personal Agent collaboration preferences may live in `knowledge/workspace/<member-id>/local/AGENTS.md`.
...
```text
knowledge/.workflow/templates/worklist.md
```
