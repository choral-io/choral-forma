...
3. Read the relevant area schema under `knowledge/.workflow/schemas/`.
...
Do not use `assignees` to mirror Kanban status. Delivery status belongs in `knowledge/planning/KANBAN.md`.
