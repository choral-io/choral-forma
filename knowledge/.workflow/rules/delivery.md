...
- Before changing delivery cards, read this document and `knowledge/.workflow/schemas/tasks.md`.
- Before updating durable knowledge during delivery, read `knowledge/.workflow/rules/knowledge.md`.
- Before using member-local execution state, read `knowledge/.workflow/rules/workspace.md`.
...
Task items live directly under `knowledge/tasks/` and follow `knowledge/.workflow/schemas/tasks.md`.
...
Use `readiness: ready` only when the task satisfies the Ready Checklist in `knowledge/.workflow/schemas/tasks.md`. In summary:
