...
summary: Validates whether Agents can use Forma CLI and configured guidelines to manage content workflows against the starter-kit pressure cases.
scope: project
type: experiment
status: completed
owners:
...
tags:
    ...
    - validation
    - agents
hypothesis: "Agents can discover and follow the intended content workflow from Forma configuration, guidelines, test cases, and task records without hard-coded repository assumptions."
metrics:
