...
Agents should treat plain Markdown files, `knowledge/schemas/*.md`, repository skills, and `knowledge/planning/KANBAN.md` as the operational rules. Agents must not rely on the Foam VS Code extension or any external Foam tool to understand or update project knowledge.
...
The full collaboration and delivery workflow is defined in `knowledge/planning/WORKFLOW.md`.
