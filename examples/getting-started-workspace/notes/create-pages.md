...
The current WebApp is read-only, but the getting-started workspace still shows how future create flows should be described by files.
...
Getting-started task pages can then point directly to operating guidance such as [[guidelines/task-selection|Task Selection]].
