...
- [[tasks/review-getting-started-workspace|Review Getting Started Workspace]]
...
Graph is a view mode, not a special global feature. This getting-started workspace includes `.forma/views/graph.md` for cross-space links and `.forma/views/guide.md` for guide-page links.
