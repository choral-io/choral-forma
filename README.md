...
```sh
curl -fsSL https://raw.githubusercontent.com/choral-io/choral-forma/main/install.sh | sh -s -- v0.1.28
```
...
mise use github:choral-io/choral-forma@0.1.28
mise install github:choral-io/choral-forma@0.1.28
forma --version
```
