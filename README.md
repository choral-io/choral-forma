...
```sh
curl -fsSL https://raw.githubusercontent.com/choral-io/choral-forma/main/install.sh | sh -s -- v0.1.23
```
...
& ([scriptblock]::Create($script.Content)) -Version v0.1.23
```
...
mise use github:choral-io/choral-forma@0.1.23
mise install github:choral-io/choral-forma@0.1.23
forma --version
```
