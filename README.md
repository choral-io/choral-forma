...
```sh
curl -fsSL https://raw.githubusercontent.com/choral-io/choral-forma/main/install.sh | sh -s -- v0.1.34
```

Windows PowerShell:

```powershell
& ([scriptblock]::Create((iwr https://raw.githubusercontent.com/choral-io/choral-forma/main/install.ps1 -UseBasicParsing).Content)) -Version v0.1.34
```
...
mise use github:choral-io/choral-forma@0.1.34
mise install github:choral-io/choral-forma@0.1.34
forma --version
```
