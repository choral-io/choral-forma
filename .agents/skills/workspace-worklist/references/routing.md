...
| Signal                          | Target                                                      |
| ------------------------------- | ----------------------------------------------------------- |
| Edited personal work summary    | `knowledge/workspace/<member-id>/summaries/`                |
| Handoff for another member      | `knowledge/workspace/<member-id>/handoffs/`                 |
| Shareable investigation         | `knowledge/workspace/<member-id>/research/`                 |
| Product requirement or behavior | `knowledge/product/`                                        |
| UI or interaction guidance      | `knowledge/design/`                                         |
| Domain term                     | `knowledge/concepts/`                                       |
| Technical structure             | `knowledge/architecture/`                                   |
| Decision or tradeoff            | `knowledge/decisions/`                                      |
| Cross-area writing or language  | `knowledge/guidelines/`                                     |
| Executable team work            | `knowledge/tasks/items/`                                    |
| Delivery status                 | `knowledge/planning/KANBAN.md` through `kanban-maintenance` |
...
Use `intake-task` when a developer receives, selects, or starts an accepted team task from `knowledge/planning/KANBAN.md`.
