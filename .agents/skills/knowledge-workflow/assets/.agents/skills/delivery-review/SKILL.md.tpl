...
description: Review delivery work before completion. Use for Reviewing cards, PR or local diff validation, acceptance checks, and Done readiness.
---
...
- For acceptance and review checklist details, read `references/checklist.md`.
